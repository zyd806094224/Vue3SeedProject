<template>
  <div>
    <el-table :data="tableData" :header-cell-style="headerCellStyle" border>
      <el-table-column prop="phonenumber" label="电话号" width="180"> </el-table-column>
      <el-table-column prop="content" label="短信内容" width="580"> </el-table-column>
